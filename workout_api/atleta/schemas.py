...
class Atleta(BaseSchema):
    ...
    cpf: Annotated[str, Field(description='CPF do atleta', examples=['19668649737'], max_length=11)]
    idade: Annotated[int, Field(description='Idade do atleta', examples=[19])]
    peso: Annotated[PositiveFloat, Field(description='Peso do atleta', examples=[80])]
